    ...
    <section class="sidebar">
      ...
      <?php if($role == "ADMINISTRATOR"): ?>
        ...
        <li class="header">MAIN NAVIGATION</li>
          ...
          WHERE
              year_need_to_notify != 0 OR
              six_months_need_to_notify != 0 OR
              three_months_need_to_notify != 0 OR
              month_need_to_notify != 0 OR
              week_need_to_notify != 0 OR
              day_before_need_to_notify != 0 OR
              date_expired_need_to_notify != 0;");
