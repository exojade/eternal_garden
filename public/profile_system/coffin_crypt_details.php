                ...
                <tr>
                  <?php for($j=1;$j<=$coffin_crypt["crypt_columns"];$j++): ?>
                    ...
                    <?php elseif($crypt_slots[$x]["active_status"] == "OCCUPIED"): ?>
                      <td><a data-id="<?php echo($crypt_slots[$x]["slot_id"]); ?>" data-toggle="modal" data-target="#modal_view_slot_<?php echo($crypt_slots[$x]["slot_id"]); ?>" href="#" class="btn btn-danger btn-block btn-flat "><?php echo($crypt_slots[$x]["slot_number"]); ?></a></td>
                    <?php endif; ?>
                    <?php $x++; ?>
                  <?php endfor; ?>
                </tr>
