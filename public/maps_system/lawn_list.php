...
<!-- Content Wrapper. Contains page content -->
  ...
  <section class="content-header">
    ...
    <div class="modal fade" id="modal_add_crypt">
          <div class="modal-dialog">
            <div class="modal-content ">
              <div class="modal-header bg-primary">
                ...
                <h3 class="modal-title text-center">Upload Loans</h3>
              </div>
      ...
      <div class="row">
      <?php foreach($lawn as $l): ?>
        <div class="col-md-4">
        <a href="lawn?action=details&id=<?php echo($l["crypt_id"]); ?>&filter=ALL">
        <div class="box box-widget widget-user">
            <div class="widget-user-header bg-green-active">
              <h3 class="widget-user-username"><?php echo($l["crypt_name"]); ?></h3>
              <h5 class="widget-user-desc">Lawn Lot</h5>
            </div>
            <div class="widget-user-image">
              <img class="img-circle" src="resources/lawn-lot.jpg" alt="User Avatar">
            </div>
            <div class="box-footer">
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header"><?php echo($Details[$l["crypt_id"]]["total"]); ?></h5>
                    <span class="description-text">SLOTS</span>
                  </div>
                </div>
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header"><?php echo($Details[$l["crypt_id"]]["vacant"]); ?></h5>
                    <span class="description-text">VACANT</span>
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="description-block">
                    <h5 class="description-header"><?php echo($Details[$l["crypt_id"]]["occupied"]); ?></h5>
