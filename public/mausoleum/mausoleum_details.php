    ...
    <div class="modal fade" id="modal_add_profile">
          <div class="modal-dialog modal-lg">
            <div class="modal-content ">
              ...
              <form class="generic_form_trigger" data-url="mausoleum">
              <input type="hidden" name="action" value="new_mausoleum_profile">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input  type="text" name="deceased_name" class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input  type="date" name="deceased_dob" class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input  type="date" name="deceased_date_death" class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input  type="date" name="deceased_burial_date" class="form-control" id="exampleInputEmail1" placeholder="---">
                </div>
              </div>
            </div>
            </div>
      ...
      <ul class="nav nav-tabs tabs-left nav-pills ">
          <?php 
            foreach($occupants as $o): ?>
              <li><a href="#<?php echo($o["profile_id"]); ?>" data-toggle="tab"><?php echo($o["deceased_name"]); ?></a></li>
            <?php
            endforeach;
          ?>
				</ul>
...
<div class="tab-pane" id="<?php echo($o["profile_id"]); ?>">
        ...
        <span class="rheader bg-primary">DECEASED INFORMATION</span>
              ...
              <label>Deceased Name</label>
							<input type="text" readonly class="form-control" value="<?php echo($o["deceased_name"]); ?>">
						</div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Date of Birth</label>
                  <input type="text" readonly class="form-control" value="<?php  echo(date('F d, Y', strtotime($o["deceased_dob"]))); ?>">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label>Date of Death</label>
                  <input type="text" readonly class="form-control" value="<?php echo(date('F d, Y', strtotime($o["deceased_date_death"]))); ?>">
                </div>
              </div>
            </div>
          ...
          <div class="form-group">
            <label>Client</label>
            <input type="text" readonly class="form-control" value="<?php echo($o["client_name"]); ?>">
          </div>
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Address</label>
                <input type="text" readonly class="form-control" value="<?php echo($o["client_address"]); ?>">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label>Contact</label>
                <input type="text" readonly class="form-control" value="<?php echo($o["client_contact"]); ?>">
              </div>
            </div>
          </div>
