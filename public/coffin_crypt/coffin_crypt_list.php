...
<!-- Content Wrapper. Contains page content -->
  ...
  <section class="content-header">
      ...
      <a href="maps?action=map_editor&type=COFFIN" class="btn btn-success pull-right btn-flat" >Open Map</a>
      </h1>
    </section>
    ...
    <div class="modal fade" id="modal_add_crypt">
          <div class="modal-dialog">
            <div class="modal-content ">
              <div class="modal-header bg-primary">
                ...
                <h3 class="modal-title text-center">Add Coffin Crypt</h3>
              </div>
              <div class="modal-body">
               
			        <form class="generic_form_trigger" url="coffin_crypt">
                <input type="hidden" name="action" value="add_coffin_crypt">
              <div class="box-body">
      ...
      <div class="row">
      <?php foreach($coffin_crypt as $coffin): ?>
        <div class="col-md-4">
        <a href="coffin_crypt?action=details&id=<?php echo($coffin["crypt_id"]); ?>">
        <div class="box box-widget widget-user">
            <div class="widget-user-header bg-aqua-active">
              <h3 class="widget-user-username"><?php echo($coffin["crypt_name"]); ?></h3>
              ...
              <div class="row">
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header"><?php echo($Details[$coffin["crypt_id"]]["total"]); ?></h5>
                    <span class="description-text">SLOTS</span>
                  </div>
                </div>
                <div class="col-sm-4 border-right">
                  <div class="description-block">
                    <h5 class="description-header"><?php echo($Details[$coffin["crypt_id"]]["vacant"]); ?></h5>
                    <span class="description-text">VACANT</span>
                  </div>
                </div>
                <div class="col-sm-4">
                  <div class="description-block">
                    <h5 class="description-header"><?php echo($Details[$coffin["crypt_id"]]["occupied"]); ?></h5>
