...
<!-- Content Wrapper. Contains page content -->
  ...
  <section class="content-header">
    ...
    <div class="modal fade" id="modal_add_crypt">
          <div class="modal-dialog">
            <div class="modal-content ">
              <div class="modal-header bg-primary">
                ...
                <h3 class="modal-title text-center">Add Common Area</h3>
              </div>
              <div class="modal-body">
               
			        <form class="generic_form_trigger" url="common_area">
                <input type="hidden" name="action" value="add_common_area">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Common Area Name</label>
      ...
      <div class="row">
      <?php foreach($common_list as $common): ?>
        <div class="col-md-4">
        <a href="common_area?action=details&id=<?php echo($common["crypt_id"]); ?>">
        <div class="box box-widget widget-user">
            <div class="widget-user-header bg-black-active">
              <h3 class="widget-user-username"><?php echo($common["crypt_name"]); ?></h3>
              <h5 class="widget-user-desc">Common Area</h5>
            </div>
                ...
                <div class="col-sm-12">
                  <div class="description-block">
                    <h5 class="description-header">
                      <?php $count = query("select count(*) as count from crypt_slot where crypt_id = ?", $common["crypt_id"]);
                            echo($count[0]["count"]);
                      ?>
                    </h5>
